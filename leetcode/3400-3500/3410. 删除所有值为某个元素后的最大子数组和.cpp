...
public:
    long long maxSubarraySum(vector<int> &nums) {
        ...
        U(i, 0, n - 1) {
            tree_arr[i] = {nums[i], nums[i], nums[i], nums[i]};
            if (nums[i] > mx1) {
                mx2 = mx1;
                mx1 = nums[i];
            } else if (nums[i] > mx2) {
        ...
        ll ans = seg.all_prod().best;
        unordered_map<int, vi> pos;
        U(i, 0, n - 1) { pos[nums[i]].pb(i); }
        ...
        for (auto &[x, v]: pos) {
            ...
            ll cur = seg.all_prod().best;

            int mx = (x == mx1) ? mx2 : mx1;
