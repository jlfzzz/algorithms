...
S op(S a, S b) {
    ...
    res.suf = b.suf;
    if (b.len == b.suf.first && a.suf.second == b.suf.second) {
        res.suf.first += a.suf.first;
    }

    res.pre = a.pre;
    if (a.len == a.pre.first && a.pre.second == b.pre.second) {
        res.pre.first += b.pre.first;
    }

    res.best = max({a.best, b.best});
    if (a.suf.second == b.pre.second) {
        res.best = max(res.best, a.suf.first + b.pre.first);
    }
    return res;
}
